<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-xl mx-auto px-4">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h2 class="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-100">Add expenses</h2>
                ...
                <form>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="date" id="expenses-date" required
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring focus:border-purple-500">
                    </div>
    ...
    <script>
        ...
        document.getElementById('expenses-date').value = new Date().toISOString().split('T')[0];
    </script>
</x-app-layout>
